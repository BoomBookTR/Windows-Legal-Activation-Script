...
:: cscript //nologo %SystemRoot%\system32\slmgr.vbs /xpr (show license)
:: cscript //nologo %SystemRoot%\system32\slmgr.vbs /dlv (show full license)
:: cscript //nologo %SystemRoot%\system32\slmgr.vbs /dli (show full license)
